...
const queryUserTool = (0, tools_1.tool)(async ({ userId }) => {
...
let AiService = class AiService {
    ...
    cronJobTool;
    modelWithTools;
    constructor(model, queryUserTool, sendMailTool, webSearchTool, dbUsersCrudTool, cronJobTool) {
...
exports.AiService = AiService = __decorate([
    ...
    __param(5, (0, common_1.Inject)('CRON_JOB_TOOL')),
    __metadata("design:paramtypes", [openai_1.ChatOpenAI, Object, Object, Object, Object, Object])
], AiService);
